    ...
    for ed = 1 : 2;
        ...
        for qqq = 1 : nq;
            ...
            for t = 1 : T;
                ...
                qsmp = engle_curve(ptmp, time_w, time_x, time_inc, time_hheq, ln_evaluate);
                qsmp = (evaluate*qsmp)./ptmp;
...
save quantile_input_allpool_1945_1955_ndur_2yr all_prices all_quantities time
